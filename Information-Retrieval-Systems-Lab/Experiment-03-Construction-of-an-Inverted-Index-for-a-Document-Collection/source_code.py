...
# ------------------------------------------------------------------
# Verified against the actual 50-document collection provided in
# IRS_Experiment_3_50_Documents_1000plus_Vocabulary.zip (documents/
# folder placed alongside this script). Confirmed output:
...
while True:
    ...
    if query in index:
        ...
        print(documents)
        # NOTE: The photographed source shows this label spelled "Docmnt
        # Frequency" (a typo in the original poster). It is preserved
        # verbatim here per the source-code fidelity requirement, even
        # though the sample-output mockup elsewhere on the poster shows
        # the corrected spelling "Document Frequency".
        print("Docmnt Frequency :", len(documents))
    else:
